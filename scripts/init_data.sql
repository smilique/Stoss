...
insert into news set caption = 'Second news item', text = 'Second news item text', time = '21/04/02 16:01:00';
insert into news set caption = 'Third news item', text = 'Third news item text', time = '21/04/03 15:01:00';
insert into news set caption = 'Fourth news item', text = 'Fourth news item text', time = '21/04/04 14:01:00';
