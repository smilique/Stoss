...
public class Commands {
    ...
    public static final String USER_UPDATE_COMMAND = "updateUser";
    ...
    public static final String CHANGE_LOCALE_COMMAND = "changeLocale";
    public static final String LOGOUT_COMMAND = "logout";
    public static final String USER_DELETE_CONFIRM_COMMAND = "confirmUserDelete";
    public static final String EDIT_USER_COMMAND = "editUser";
    public static final String USER_SPECIFIED_UPDATE_COMMAND = "updateSpecifiedUser";
}
